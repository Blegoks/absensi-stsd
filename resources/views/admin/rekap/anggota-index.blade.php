...
@section('title', 'Rekap Anggota - ' . $juruarah->name)
...
<div class="bg-white p-6 rounded shadow">
    ...
    <a href="{{ route('admin.rekap.index') }}"
       class="text-blue-600 underline mb-3 inline-block">← Kembali ke Juru Arah</a>
    ...
    <form method="GET" class="mb-4 flex flex-wrap gap-2 items-end">
        ...
        <!-- Tombol Export Excel -->
        <a href="{{ route('admin.rekap.anggota.export', ['id' => $juruarah->id, 'search' => request('search'), 'tanggal_mulai' => request('tanggal_mulai'), 'tanggal_selesai' => request('tanggal_selesai')]) }}"
    ...
    <table class="table-auto w-full text-sm border">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-3 py-2">
                    <a href="{{ route('admin.rekap.absensi.detail', $anggota->id) }}"
